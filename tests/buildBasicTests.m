...
switch basicOp
    ...
    case 'Diag'
        ...
        text = ...
            ...
            'd = ', d_vect, ';\n',...
            'data = struct(''operator'', op',basicOp,'(d), ''relativeTol'', ', num2str(relativeTol),');\n',...
            'A = op',basicOp,'(d);\n',...
            'end\n'];
    ...
    case 'Haar'
        ...
        text = ...
            ['function data = setup\n'...
            '%%Calling the constructor for', basicOp, '.\n',...
            'data = struct(''operator'', op',basicOp,'(',num2str(m),',',num2str(n),',',num2str(l),'), ''relativeTol'', ', num2str(relativeTol),');\n',...
            'end\n'];
    ...
    case 'Hadamard'
        ...
        text = ...
            ['function data = setup\n'...
            '%%Calling the constructor for', basicOp, '.\n',...
            'data = struct(''operator'', op',basicOp,'(',num2str(n),'), ''relativeTol'', ', num2str(relativeTol),');\n',...
            'end\n'];
    ...
    case 'Toeplitz'
        ...
        text = ...
            ...
            '%%Calling the constructor for', basicOp, '.\n',...
            'v = ', v_vect, ';\n',...
            'data = struct(''operator'', op',basicOp,'(',num2str(m),',',num2str(n),', v), ''relativeTol'', ', num2str(relativeTol),');\n',...
            'end\n'];
...
text = ...
    ['function data = setup\n'...
    '%%Calling the constructor for', basicOp, '.\n',...
    'data = struct(''operator'', op',basicOp,'(',num2str(m),',',num2str(n),'), ''relativeTol'', ', num2str(relativeTol),');\n',...
    'end\n'];

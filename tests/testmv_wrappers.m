function test_suite = testmv_wrappers
%testmv_wrappers  Multivector unit tests for the wrappers opCTranspose,
% opConj, opTranspose
initTestSuite;
end

function test_wrappers_opConj
%% Test for opConj
m  = randi(100);
n  = randi(100);
...
function test_wrappers_opCTranspose
...
function test_wrappers_opTranspose
...
function test_wrappers_opMinus
%% Test for opMinus
m  = randi(100);
n  = randi(100);
a1 = randn(m,n) + 1i*randn(m,n);
